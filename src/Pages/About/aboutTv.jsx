...
import SeriesRating from './../../Components/Rating/SeriesRating';
...
export default class aboutTv extends Component {
    ...
    TvShowDetails = async (series) => {
        ...
        if (this.props.location.pathname !== undefined) {
            ...
            this.state.series = localStorage.getItem('series');

        await axios.get(`https://api.themoviedb.org/3/tv/${series.id}?api_key=0c46ad1eb5954840ed97f5e537764be8&append_to_response=all`).then((res) => {
    ...
    IFrame = async (item) => {
        await axios.get(`https://api.themoviedb.org/3/tv/${item.id}/videos?api_key=0c46ad1eb5954840ed97f5e537764be8&`).then((res) => {
            ...
            <>
                ...
                <section style={{ minHeight: "71vh" }} >
                    ...
                    <div className="container about">
                                ...
                                (<div className="row  d-flex justify-content-start">
                                    ...
                                    <div className="col-xl-5 col-lg-5 col-md-5 col-sm-12 my-2">
                                        ...
                                        <div className="text-center position-relative mb-2">
                                            ...
                                            <div className="mb-3">
                                                <img src={`https://image.tmdb.org/t/p/original/${this.state.tvShowDetails.poster_path}`} className="w-100 h-100" alt={this.state.tvShowDetails.title !== "undefined" ? this.state.tvShowDetails.title : this.state.tvShowDetails.name} title={this.state.tvShowDetails.title === "undefined" ? this.state.tvShowDetails.name : this.state.tvShowDetails.title} />
                                            </div>

                                            <b>{this.state.tvShowDetails.title} {this.state.tvShowDetails.name}</b>
                                            <span className={`${this.state.tvShowDetails.vote_average >= 7 ? "vote vote1" : "vote vote2"}`}>{this.state.tvShowDetails.poster_path !== null ? this.state.tvShowDetails.vote_average : ""}</span>
                                        </div>
                                    </div>
                                    ...
                                    <div className="col-xl-7 col-lg-7 col-md-7 col-sm-12 my-2 mx-auto">
                                        ...
                                        <table className="table table-borderless" >
                                            <thead>
                                                <tr>
                                                    ...
                                                    <td> {this.state.tvShowDetails.title}{this.state.tvShowDetails.name}</td>
                                                </tr>
                                            </thead>
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a href={this.state.tvShowDetails.homepage ? this.state.tvShowDetails.homepage : `/about`} target="_blank" rel="noreferrer" className="text-decoration-none font-weight-bold">{this.state.tvShowDetails.homepage ? "Homepage" : "Not Supported"} </a> </td>
                                                </tr>
                                                <tr>
                                                    <th>Genres</th>
                                                    <td>
                                                        {
                                                            React.Children.toArray(this.state.tvShowDetails.genres.slice(0, 2).map((genre) => <span className="genres">{genre.name}</span>))
                                                        }
                                                    </td>
                                                </tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td> {this.state.tvShowDetails.first_air_date != null ? this.state.tvShowDetails.first_air_date : "Not Release"}</td>
                                                </tr>
                                                <tr>
                                                    <th>Popularity</th>
                                        ...
                                        <div>
                                            <button className="btn btn-info mr-3" onClick={() => this.getDownload(this.state.tvShowDetails.title ? this.state.tvShowDetails.title : this.state.tvShowDetails.name)} >Download</button>
                                        ...
                                        this.state.iFrame ? (
                                            <>
                                                ...
                                                <div className="col-lg-8 col-md-10 col-sm-12 mx-auto">
                                                    <h1 className="text-center mb-4"> Trial For {this.state.tvShowDetails.name ? this.state.tvShowDetails.name : this.state.tvShowDetails.title}</h1>
                                                    <div>
                        ...
                        <TvActors actors={this.props.location.state} goToPersonAbout={this.goToPersonAbout} />

                        <Seasons Season={this.props.location.state} goToSeason={this.goToSeason} />

                        <TvSimilar series={this.props.location.state} goToTvAbout={this.goToTvAbout} />

                        <TvRecommendations series={this.props.location.state} goToTvAbout={this.goToTvAbout} />

                        <SeriesRating rate={this.props.location.state} />
