...
const PersonShow = ({ poster }) => {
        ...
        return img.file_path ? (
            <div className="itemHover card card-body">
                <div className="captionLayer overflow-hidden carouselItem">
                    <img src={`https://image.tmdb.org/t/p/original${img.file_path}`} className="carouselItem__img" width="100%" height="300" alt="" onDragStart={handleDragStart} />
                </div>
            </div>
        ) : null
    })
    ...
    const fetchImages = async () => {
        await axios.get(`https://api.themoviedb.org/3/person/${poster.id}/images?api_key=0c46ad1eb5954840ed97f5e537764be8`).then((res) => {
