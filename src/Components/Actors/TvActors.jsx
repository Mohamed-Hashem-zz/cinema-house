...
const TvActors = ({ actors, goToPersonAbout }) => {
                    ...
                    <div className="item card card-body" onClick={() => goToPersonAbout(actor)}>
                        <div className="position-relative text-center">
                            <div className="captionLayer overflow-hidden carouselItem mb-2">
                                <img src={`https://image.tmdb.org/t/p/original/${actor.profile_path}`} width="100%" height="350px" className="carouselItem__img" alt=".." onDragStart={handleDragStart} />
    ...
    const fetchActors = async () => {
        ...
        await axios.get(`https://api.themoviedb.org/3/tv/${actors.id}/aggregate_credits?api_key=0c46ad1eb5954840ed97f5e537764be8`)
            .then((response) => {
                setLoading(true)
    ...
    return loading ? (
        <>
            ...
            <div className="item  text-center mx-auto my-3">
                <h3>The Actors Who Take Part In <b className="text-info">{actors.title ? actors.title : actors.movieTitle}</b></h3>
            </div>
