                    ...
                    <div className="row  d-flex justify-content-start">
                        ...
                        <div className="col-xl-5 col-lg-5 col-md-5 col-sm-12 my-2">
                            ...
                            <div className="text-center position-relative mb-2">
                                ...
                                <div className="mb-3">
                                    <img src={`https://image.tmdb.org/t/p/original${props.location.state.still_path}`} style={{ width: "100%", height: "100%" }} alt={props.location.state.name} title={props.location.state.name} onDragStart={handleDragStart} />
                                </div>

                                <span className={`${props.location.state.vote_average >= 7 ? "vote vote1" : "vote vote2"}`}>{props.location.state.still_path !== null ? props.location.state.vote_average : ""}</span>
